...
the classify_wetdry function allows the user to define both a method and
threshold value to generate a binary “wet/dry” data set.
...
# This function intakes a raw CSV file and outputs a tidy data frame with the following column names: datetime, conductivity_uncal, temperature
...
The second function is called get_calibration and is demonstrated below:

``` r
# This function intakes a STIC calibration data frame with columns "standard" and "conductivity_uncal"and outputs a fitted model object relating spc to the uncalibrated conductivity values measured by the STIC
...
below. This function intakes a tidy STIC data frame (as generated by
tidy_hobo_data), as well as the fitted model object generated by
...
produced by apply_calibration or tidy_hobo_data. The user is also asked
to specify a method for classification, as well as a threshold
